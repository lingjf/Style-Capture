...
var DomOutline = function (options) {
    ...
    function createOutline() {
        ...
        self.elements.top = jQuery('<div></div>').addClass('DomOutline_side').appendTo('body');
        self.elements.bottom = jQuery('<div></div>').addClass('DomOutline_side').appendTo('body');
        self.elements.left = jQuery('<div></div>').addClass('DomOutline_side').appendTo('body');
        self.elements.right = jQuery('<div></div>').addClass('DomOutline_side').appendTo('body');
    }
    ...
    function updateOutline() {
        ...
        var pos = {left:0, top:0, width:0, height:0, right:0, bottom:0};
        var label_text = "";
        if (pub.selected) {
    ...
    function keyStringInside(keyString, keyList) {
    	return keyList.indexOf(keyString) > -1;
